...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/INDOLOGY/";
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/INDOLOGY/about/";
              },
            },{id: "dropdown-contact",
              title: "Contact",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/INDOLOGY/contact/";
              },
            },{id: "dropdown-archives",
              title: "Archives",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/INDOLOGY/archives/";
              },
            },{id: "dropdown-subscribe",
              title: "Subscribe",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/INDOLOGY/subscribe/";
              },
        ...
        handler: () => {
            ...
            window.location.href = "/INDOLOGY/blog/2025/promotional-video/";
        ...
        handler: () => {
            ...
            window.location.href = "/INDOLOGY/blog/2025/manuscript-frequencies/";
        ...
        handler: () => {
            ...
            window.location.href = "/INDOLOGY/blog/2025/intertextuality-full/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/INDOLOGY/books/the_godfather/";
          ...
          section: "News",handler: () => {
              window.location.href = "/INDOLOGY/news/announcement_2/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/INDOLOGY/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
